...
function ProductForm(props) {
  ...
  return(
    <>
    <h2 className="text-center mb-3">{props.product.id ? "Edit Product" : "Create Product"}</h2>
        ...
        <form onSubmit={(event) => handleSubmit(event)}>
          ...
          <div className="row">
            ...
            <div className="col-sm-4 d-grid">
              <button onClick={() => props.showList()} type="button" className="btn btn-secondary btn-sm me-4">Cancel</button>
            </div>
          </div>
        </form>
      </div>
